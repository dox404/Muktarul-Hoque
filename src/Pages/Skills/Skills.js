...
function Skills() {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 flex h-screen items-center justify-center overflow-auto">
